...
export const addProtectionPlan = async (formData: FormData, customerVehicleId: string, invoiceUrl: string): Promise<{error?: string}> => {
    ...
    try {
        ...
        return { error: error.message || 'Something went wrong while adding new protection plan. Please try again. ' }
    }
}
...
export const getProtectionPlanById = async (planId : string ): Promise<{plan?: ExtendedProtectionPlan, error?: string}> => {
 ...
 export const updateProtectionPlan = async (formData: FormData, planId: string, invoiceUrl: string ): Promise<{ protectionPlan?: ExtendedProtectionPlan, error?: string }> => {
    try {
        ...
        return { error: 'Something went wrong while updating protection plan' }
    }
 }
